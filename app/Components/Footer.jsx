...
const Footer = () => {
  return (
    <footer>
      <div className="w-full p-20 mt-20 min-h-[70vh]  mx-auto flex items-center justify-center bg-gradient-to-r from-[#0B0827] to-[#232139]">
        <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
          ...
          <div>
            <div className="mt-24 mb-12 md:flex-row justify-between">
              <div className="flex max-w-7xl mx-auto justify-between">
                <div>
                  {/* logo */}
                  <Link href="/" className="flex items-center">
                    <Image src={Logo} alt="img logo" width={130} />
                  </Link>
                </div>
                <div>
            ...
            <p className="w-full text-center my-12 text-gray-600">
              Copyright © 2024 TechPro - Imad Niabou
            </p>
          </div>
        </div>
      </div>
